        ...
        <div className='mb-4'>
            <div className='SearchSecion d-flex'>
                <div className='SearchBox mx-auto mt-5'>
                    ...
                    <input className='nameinput border-0 bg-white mt-4 py-1 ps-3 fs-4' type='text' placeholder='Search Recipes ' required/>
                    <div className='NumberRecipes d-flex justify-content-center pt-4 '>
                        <p className='me-3 mt-2'> number of recipes : </p>
                        <input className='border-0 mb-2 ' type='text' required/>
                    </div>
