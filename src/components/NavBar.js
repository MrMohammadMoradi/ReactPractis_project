            ...
            <div className="container-fluid bg-dark ">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="d-flex">
                        <a href='##'> <button className="btn text-white bg-info px-2 mx-2 rounded-pill" type="submit">Log In</button> </a>
                        <a href='###'> <button className="btn text-white bg-primary rounded-pill" type="submit">Sign Up</button> </a>
                    </div>
                </div>
            </div>
        </nav>
